/*
     Description : This is the model in the model-widget paradigm. A new instance of 
	 CarouselModel backs an instance of Carousel. 
	 ...
	 2) Interacts with the pagintionStrategy, when the user clicks on left/right button, 
	    Carousel calls the appropriate method in this module. Here it delegates the interaction 
		to the paginationStrategy to get the new Carousel state. 
