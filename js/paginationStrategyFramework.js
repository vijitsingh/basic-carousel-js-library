/*
    Description : This is the paginationStrategy framework which supports getting an instance 
	of a paginationStrategy. It also supports adding of new custom strategies. 
	By default this creates an instance of a default strategy which is nothing but shows the 
	next set of cards available. NOTE that it is very easy to add a new strategy. 
	Other variations could be as follows : 
